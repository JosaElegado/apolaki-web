...
def hero(h1, sub, ctas, img, alt, kicker="Apolaki", rail=None, theme="",
         variant="band", figure=None, fignote=None):
    return S.phero(kicker=kicker, h1=h1, sub=sub, ctas=ctas, img=img, alt=alt,
                   rail=rail, theme=theme, variant=variant,
                   figure=figure, fignote=fignote)
...
def build_about():
    ...
    body = hero(
        ...
        px(6961123, 1400, 1050), "Solar technicians installing panels under a clear sky", variant='immersive', kicker='About Apolaki', theme='th-sky', rail=[('<span data-c="3" data-d="0">3</span>', 'MIB students who got tired of watching people guess'),
              ('<span data-c="1" data-d="0">1</span><span class="u">platform</span>', 'The first solar adoption platform built for the Philippines'),
              ('<span>2026</span>', 'The year we stopped talking about it and shipped')]) + f"""
<section class="sec-tight">
  <div class="w">
    <div class="statrow r">
      <div class="stat-c"><div class="sv mono"><span>2025</span></div><div class="sl">Founded at the Asian Institute of Management</div></div>
...
{S.strip("https://images.pexels.com/photos/35454190/pexels-photo-35454190.jpeg?auto=compress&cs=tinysrgb&w=1800&h=900&fit=crop", "Solar panels catching the afternoon sun", caption=None)}
<section class="sec">
  <div class="w">
...
def build_faqs():
    ...
    body = hero(
        ...
        px(9875422, 1400, 1050), "Solar technician installing panels on a house roof", variant='bare', kicker='Questions', theme='th-white', rail=[('<span data-c="22" data-d="0">22</span><span class="u">answers</span>', 'The ones people actually ask us'),
              ('<span data-c="10" data-d="0">10</span><span class="u">days</span>', 'How long net metering approval can legally take now'),
              ('<span data-c="100" data-d="0">100</span><span class="u">kW</span>', 'The ceiling every home system sits under')]) + f"""
<section class="sec">
...
{S.bigtype("No question about solar is too small to ask.", "If it is on your mind it is on everyone else&rsquo;s too. Ask us the one that is not here and we will add it.", sky=True)}
<section class="sec-tight tint">
  <div class="w">
    <div class="callband r">
...
{S.slimband("https://images.pexels.com/photos/35454190/pexels-photo-35454190.jpeg?auto=compress&cs=tinysrgb&w=1800&h=420&fit=crop", "Solar panels on a roof")}
  ...
  <div class="w">
    <div class="tlg">
      ...
      <div class="r">
        ...
        <div class="plinks r">
          <a href="/installers"><span>Become a trusted installer</span>
