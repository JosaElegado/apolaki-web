...
GAL_ITEMS = [
    ('https://images.pexels.com/photos/9799727/pexels-photo-9799727.jpeg?auto=compress&cs=tinysrgb&w=900&h=680&fit=crop', 'Installer fitting panels on a rooftop', 'Customers who did the homework', 'System size, budget and savings, already worked out from a real bill before they reach you.'),
    ('https://images.pexels.com/photos/9875422/pexels-photo-9875422.jpeg?auto=compress&cs=tinysrgb&w=900&h=680&fit=crop', 'Technician installing a panel on a house roof', 'You know they can pay', 'Bill range and financing status arrive on the brief, before you price the job.'),
    ('https://images.pexels.com/photos/11645008/pexels-photo-11645008.jpeg?auto=compress&cs=tinysrgb&w=900&h=680&fit=crop', 'Crew working on a Philippine rooftop', 'Far less spent on marketing', 'No boosted posts, no lead brokers, nobody cold-calling all afternoon.'),
    ('https://images.pexels.com/photos/38171120/pexels-photo-38171120.jpeg?auto=compress&cs=tinysrgb&w=900&h=680&fit=crop', 'Rooftop solar array in sunlight', 'Supplies through the platform', 'Panels, inverters and mounting at platform pricing. No single-distributor lock-in.'),
    ('https://images.pexels.com/photos/35454190/pexels-photo-35454190.jpeg?auto=compress&cs=tinysrgb&w=900&h=680&fit=crop', 'Solar panels on a roof', 'Ranked on work, not budget', 'Your place on the shortlist comes from finished projects. It cannot be bought.'),
    ('https://images.pexels.com/photos/29206488/pexels-photo-29206488.jpeg?auto=compress&cs=tinysrgb&w=900&h=680&fit=crop', 'Solar installation detail', 'A profile homeowners read', 'Portfolio, certifications and service areas, inside the decision rather than on Facebook.'),
]
...
def build():
    ...
    xh = S.phero(
        kicker='For installers',
        h1='The quickest way to <em>get more solar leads</em> and grow your business.',
        sub='Join the Apolaki trusted installer pool. Every homeowner who reaches you already knows their system size, their savings and their budget, so you quote instead of qualify.',
        ctas=f'<a href="/contact?type=installer" class="b b-blue">Become a trusted installer {AR}</a> <a href="contact.html?type=onboarding" class="b b-glass">Book an onboarding call</a>',
        img='https://images.pexels.com/photos/8853504/pexels-photo-8853504.jpeg?auto=compress&cs=tinysrgb&w=1400&h=1750&fit=crop',
        alt='Installers fitting solar panels on a rooftop',
        theme='th-sky',
        variant='split',
        rail=[('<span data-c="10" data-d="0">10</span><span class="u">days</span>', 'The new legal limit on a net metering approval'),
              ('<span data-c="0" data-d="0">0</span><span class="u">permits</span>', 'Pre-installation clearances, since the July 2026 DOE circular'),
              ('&#8369;<span data-c="0" data-d="0">0</span>', 'What it costs to be listed during the pilot')])
    body = f"""{xh}


<section class="sec">
  <div class="w">
    <div class="sh c r"><h2>Join our growing list of <em>trusted installers.</em></h2></div>
    <div class="logowall r">
      <div class="lw"><span>Your logo here</span></div>
      <div class="lw"><span>Your logo here</span></div>
      <div class="lw"><span>Your logo here</span></div>
      <div class="lw"><span>Your logo here</span></div>
      <div class="lw"><span>Your logo here</span></div>
    ...
    <p class="lw-note r">Verified installers currently onboarding across Metro Manila, Rizal, Cavite and Laguna.</p>
  </div>
</section>
...
<section class="sec" id="join">
  <div class="w">
    ...
    <div class="jsteps">
      <article class="jstep r"><div class="jid">01</div><div class="jic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M9 15h6M9 11h3"/></svg></div><div>
        <h3>Apply</h3>
        <p>Send your registration, your licensed electrician and a few finished projects. Ten minutes.</p>
      </div></article>
      <article class="jstep r"><div class="jid">02</div><div class="jic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg></div><div>
        <h3>Get verified</h3>
        <p>We check all three against public records. A few days, and the badge actually means something.</p>
      </div></article>
      <article class="jstep r"><div class="jid">03</div><div class="jic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1v22"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg></div><div>
        <h3>Start quoting</h3>
        <p>Briefs land with roof size, budget, financing status and timeline. You quote instead of qualify.</p>
      </div></article>
      <article class="jstep r"><div class="jid">04</div><div class="jic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 17l5-5 4 3 5-7"/><path d="M17 8h4v4"/></svg></div><div>
        <h3>Grow with us</h3>
        <p>Pick your cities and system sizes. Your ranking comes from finished work, never from ad spend.</p>
      </div></article>
    </div>
...
{S.strip("https://images.pexels.com/photos/9799727/pexels-photo-9799727.jpeg?auto=compress&cs=tinysrgb&w=1800&h=900&fit=crop", "Installers fitting panels on a Philippine rooftop", caption=None)}
<section class="sec">
  <div class="w">
    <div class="sh r">
...
{S.slimband("https://images.pexels.com/photos/9799727/pexels-photo-9799727.jpeg?auto=compress&cs=tinysrgb&w=1800&h=420&fit=crop", "Installers at work on a rooftop")}
